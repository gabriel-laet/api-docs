...
## Create cost center
This mutation can used to create a new cost center, but only **administrators** can create. It returns a paginated list of all cost centers including the new one.
```
mutation {
...
This mutation update the information of financial contact. The request will return the updated informations.
```
mutation {
  updateFinancialContact(input: {
    clientMutationId: "a_client_id", 
...
```
{
  "data": {
    "updateFinancialContact": {
      "clientMutationId": "12",
      "financialContact": {
        "id": "QWRkaXRpb25hbENvbnRhY3ROb2RlOjE=",
        "fullName": "Financial Contact",
        "email": "financial@company.com",
        "landline": "1130755449",
        "mobile1": "1197553386"
